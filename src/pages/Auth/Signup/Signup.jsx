...
const Signup = () => {
  ...
  const onSubmit = (values) => {
    ...
    createUser
      .runAsync(newValues)
      .then(() => {
        swal("Sign Up Success!", "", "success").then(() => navigate("/signin"));
      })
      .catch((error) => {
        swal(`${error}!`, "", "warning");
      });
        ...
        <div className={styles.signupLeft}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={styles.checkboxTerms}>
              ...
              />{" "}
              <label htmlFor="terms">I agree to the terms of services</label>
            </div>
            {errors.terms && (
              <span className={`${styles.errorMess} ${styles.checkboxError}`}>
